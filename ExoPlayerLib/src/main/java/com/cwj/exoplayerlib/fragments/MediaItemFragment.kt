...
import com.cwj.exoplayerlib.adapter.MediaItemAdapter
import com.cwj.exoplayerlib.common.InjectorUtils
import com.cwj.exoplayerlib.databinding.FragmentMediaitemListBinding
...
class MediaItemFragment : Fragment() {
    private val mainActivityViewModel by activityViewModels<MediaRootViewModel> {
        InjectorUtils.provideMediaRootViewModel(requireContext())
    }
