...
/**
 * 该对象包装了Camera服务对象，并期望是唯一与之对话的对象。 该实现封装了拍摄预览大小的图像所需的步骤，这些图像用于预览和解码。
 * <p>
...
public final class CameraManager {
    ...
    /**
     * 计算UI应该绘制以向用户显示条形码放置位置的框架。 该目标有助于对齐，并迫使用户将设备握得足够远，以确保图像清晰对焦。
    ...
    /**
     * 像{@link #getFramingRect}一样，但是坐标是基于预览框架，而不是UI /屏幕。
     * Like {@link #getFramingRect} but coordinates are in terms of the preview frame,
     * not UI / screen.
     * <p>
     * {@link Rect}以预览尺寸表示条形码扫描区域
     *
