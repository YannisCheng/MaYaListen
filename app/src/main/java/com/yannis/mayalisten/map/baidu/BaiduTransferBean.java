 ...
 * @date 2019-08-01
 */
public class BaiduTransferBean implements Serializable {
    ...
    public BaiduTransferBean(String country, String province, String city, String district, String addressName, String addressSnippet, double latitude, double longitude) {
